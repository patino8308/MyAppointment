...
const noHoursAlert = `<div class="alert alert-danger" role="alert">
    <strong>Lo Sentimos!</strong> No se encontro Horario disponible para el médico en el día seleccionado!
</div>`;
$(function() {
    $specialty = $("#specialty");
    $doctor = $("#doctor");
...
function getRadioIntervalHtml(interval) {
  ...
  <input name="scheduled_time" value="${
      interval.start
  }" class="custom-control-input" id="interval${iRadio}" type="radio"  required>
